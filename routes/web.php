...
Route::middleware(['guest:employee'])->group(function () {
    ...
    Route::get('/daftar-baru', [EmployeeController::class, 'prosesRegister'])->name('prosesRegister');
    Route::post('/daftar/store', [EmployeeController::class, 'registerStore'])->name('registerStore');
});
...
Route::middleware(['auth:employee'])->group(function () {
    ...
    Route::get('/download_steguran/{employee_id}', [DashboardController::class, 'teguran'])->name('surat-teguran');
    Route::get('/download_sp/{employee_id}', [DashboardController::class, 'peringatan'])->name('surat-peringatan');
    ...
    Route::post('/change-profile', [ProfileController::class, 'change'])->name('change.profile');
...
Route::middleware(['auth:user'])->group(function () {
    ...
    Route::get('/manage/rekap-sp', [RekapAbsensiController::class, 'sp'])->name('rekap.sp');

    Route::get('/sign-out', [AuthController::class, 'dashboardLogout']);
});
