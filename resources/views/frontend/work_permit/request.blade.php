            ...
            <div class="form-row">
                <div class="col-md-12">
                    <div class="form-group mb-5">
                        <label class="form-label" for="start_date">Tanggal Mulai Ijin <sup><span
                    ...
                    <div class="form-group mb-5">
                        <label class="form-label" for="end_date">Tanggal Akhir Ijin <sup><span
                                    style="color: #dc3545">(*)</span></sup></label>
                    ...
                    <div class="form-group mb-5">
                        <label class="form-label" for="attachment">Attachment (Opsional), <sup><span
                                    style="color: #d66a12">(Screenshot/ Foto (Format: PNG, JPG), Max:
                                    2MB)</span></sup></label>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Pilihan Upload Attachment</h5>
                    ...
                    <img id="preview" src="#" alt="attachment" class="mt-3 mb-3" style="display:none;width:250px;height:250px;"/>
        ...
        $(document).ready(function() {
            ...
            $("#take_snapshot").click(function() {
                Webcam.snap(function(data_uri) {
                    ...
                    $("#hasil_webcam").html('<img style="width:250px;height:250px" src="' + data_uri + '" />');
