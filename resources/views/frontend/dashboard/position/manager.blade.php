                        ...
                        <div class="modal fade" id="approval_ijin" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="tidakacc" action="{{ route('tolak.manager') }}" method="post" hidden
                                        class="d-inline">
                                        @csrf
                                        <div class="modal-body approval_ijin">
                                            ...
                                            <input type="hidden" name="approval_2" value="0">
                                            <input type="hidden" name="status_2" value="TIDAK ACC MANAGER">
                                            <div class="form-group col-md-12">
                                                <label class="form-label" for="fullname">Alasan Penolakan:</label>
                                                <textarea class="form-control" id="reject_2" name="reject_2" rows="5"></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <ul class="list-inline m-0 p-0">
                                ...
                                <li class="d-flex mb-4 align-items-center">
                                    ...
                                    <form onsubmit="return confirmApprove(event)"
                                        action="{{ route('approve.manager') }}" method="post" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $item->employee_id }}">
                                        <input type="hidden" name="status_2" value="ACC MANAGER">
                                        <input type="hidden" name="approval_2" value="1">
                                        @if ($item->status_2 == 'TIDAK ACC MANAGER')
                        ...
                        <div class="modal fade" id="approval_cuti" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="tidakacc-cuti" action="{{ route('tolak-cuti.manager') }}"
                                        method="post" hidden class="d-inline">
                                        @csrf
                            ...
                            <ul class="list-inline m-0 p-0">
                                ...
                                <li class="d-flex mb-4 align-items-center">
                                    ...
                                    <form onsubmit="return confirmApproveCuti(event)"
                                        action="{{ route('approve-cuti.manager') }}" method="post"
                                        class="d-inline">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $item->employee_id }}">
                                        <input type="hidden" name="status_2" value="ACC MANAGER">
                                        ...
                                        @if ($item->status_1 == 'TIDAK ACC MANAGER')
                                            <span class="stamp is-denied">DITOLAK</span>
                                            <button disabled type="submit" class="btn btn-sm btn-icon btn-danger"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Approve"
                                                href="#">
