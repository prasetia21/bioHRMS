...
<head>
    ...
    <title>Form Penilaian Teknisi</title>
    ...
    <div class="container contact-form">
        ...
        <form id="frmTeknisi" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <input type="text" class="form-control" id="nama_teknisi" name="nama_teknisi" hidden>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('select[name="office_id"]').on('change', function() {
                ...
                if (office_id) {
                    $.ajax({
                        url: "{{ url('/teknisi/ajax') }}/" + office_id,
                        type: "GET",
                        dataType: "json",
        ...
        $(document).ready(function() {
            ...
            $("#employee_id").change(function() {
                var value = $(this).val();
                var teknisi = $(this).find("option:selected").text();
                $("#nama_teknisi").val(teknisi);
            }).change(); // Trigger initial change
