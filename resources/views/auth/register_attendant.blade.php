...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="container contact-form" style="margin-top: 30px;margin-bottom: 30px">
            ...
            <form id="frmProfile" action="{{ route('registerStore') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-row">
                    <input type="hidden" name="backup_photo">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <img id="preview" src="" alt="" class="mt-3 mb-3" style="display:block" />
                            <input type="hidden" name="image_data" id="image_data">

                            <label class="form-label" for="attachment">Foto Profile, <sup><span
                                        style="color: #d66a12">(Foto
                                        (Format: PNG, JPG), Max:
                                        2MB)</span></sup></label>
                        ...
                        @if (!empty($departements) && $departements->count() > 0)
                            <div class="form-group mb-3">
                                <label for="departement_id" class="form-label">Unit Kerja</label>
                        ...
                        @else
                            <div class="alert alert-bottom alert-danger alert-dismissible fade show " role="alert">
                                <span> Tambahkan Dahulu data Departemen! <a href="{{ route('departemen') }}">Klik
                                        disini
                        ...
                        @else
                            <div class="alert alert-bottom alert-danger alert-dismissible fade show " role="alert">
                                <span> Tambahkan Dahulu data Posisi! <a href="{{ route('position') }}">Klik disini
                                    </a>untuk menambahkan</span>
                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                        ...
                        <div class="password-section">
                            <h4 class="head">Setting Password Baru</h4>
                        </div>
                        <hr>
                        <div class="form-group mb-3">
 ...
 --}}
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Pilihan Upload Foto Profile
                                        </h5>
                                                                        ...
                                                                        <div class="h-100">
                                                                            <div class="dplay-tbl">
                                                                                <div class="dplay-tbl-cell">
                                                                                    ...
                                                                                    <h5><b>Pilih File dari
                                                                                            Penyimpanan</b></h5>
                                                                                    <h6 class="mt-10 mb-70">atau Drag
                                                                                        and Drop
                                                                                        File
                                                                                        anda
                                                                                    </h6>
                ...
                <div class="form-group mt-3 text-center">
                    <input type="submit" name="btnSubmit" id="btnSubmited" class="btnContact" value="Daftar" />
                    <div id="msg"></div>
                </div>
