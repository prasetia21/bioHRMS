...
@section('title')
    Laporan Sales Industri - BIO HRMS
@endsection

@section('banner-title')
    Laporan Sales Industri
@endsection
                ...
                <div class="col-sm-12">
                    <div class="card">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <form method="get" action="laporan-sales-industri">
                        ...
                        @else
                            ...
                            <div class="d-flex justify-content-center"><a href="{{ route('laporan-sales-industri') }}" class="mt-2 btn btn-primary" role="button">Reset</a></div>
                            <hr>
                        @endif
                    </div>
                </div>
