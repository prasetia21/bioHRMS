                ...
                <div class="col-sm-12">
                    <div class="card">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <form method="get" action="laporan-sales-retail">
                                ...
                                <div class="table-responsive">
                                    <table id="user-list-table" class="table table-striped" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $employee = App\Models\Employee::with('departement')->where('id', $item->employee_id)->first();
                        ...
                        @else
                            ...
                            <div class="d-flex justify-content-center"><a href="{{ route('laporan-sales-retail') }}" class="mt-2 btn btn-primary" role="button">Reset</a></div>
                            <hr>
                        @endif
                    </div>
                </div>
