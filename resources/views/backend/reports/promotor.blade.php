                ...
                <div class="col-sm-12">
                    <div class="card">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <form method="get" action="laporan-promotor">
                                    ...
                                    <table id="user-list-table" class="table table-striped" role="grid"
                                        ...
                                        <thead>
                                            <tr class="ligth">
                                                ...
                                                <th>Lokasi Pemasangan Spanduk</th>
                                                <th>Jenis Spanduk</th>
                                                <th>Catatan Pemasangan Spanduk</th>
                                                <th>Lokasi Event</th>
                                                <th>Jenis Event</th>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->lokasi_pemasangan_spanduk }}</td>
                                                    <td>{{ $item->jenis_spanduk }}</td>
                                                    <td>{{ $item->catatan_pemasangan_spanduk }}</td>
                                                    <td>{{ $item->lokasi_event }}</td>
                                                    <td>{{ $item->jenis_event }}</td>
                                                    <td>{{ $item->jumlah_peserta }}</td>
                                                    <td>{{ $item->hasil_event }}</td>
                        ...
                        @else
                            ...
                            <div class="d-flex justify-content-center"><a href="{{ route('laporan-promotor') }}" class="mt-2 btn btn-primary" role="button">Reset</a></div>
                            <hr>
                        @endif
                    </div>
                </div>
