        ...
        <div>
            <div class="row">
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form id="myForm" style="display: block ruby" action="{{ route('change.employee') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $data->id }}">
                    <input type="hidden" name="backup_photo" value="{{ $data->photo }}">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="profile-img-edit position-relative">
                                        ...
                                        <img id="preview" src="{{ (!empty($data->photo)) ? asset('picture/accounts/' . $data->photo) : asset('picture/accounts/01.png') }}" alt="profile-pic"
                                ...
                                @if (!empty($levels) && $levels->count() > 0)
                                    <div class="form-group">
                                        ...
                                        <select name="user_level_id" class="selectpicker form-control" data-style="py-0"
                                            ...
                                            <option value="{{ $data->level->id }}">{{ $data->level->role }}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        @if (!empty($departements) && $departements->count() > 0)
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="departement_id" class="form-control" id="departement_id"
                                                    required>
                                                    <option value="{{ $data->departement->id }}">{{ $data->departement->name }}</option>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" value="{{ $data->phone }}"
                                                placeholder="Mis: 0274-12345 / 08xxxxxxxxx" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="birth_place">Tempat Lahir:</label>
                                            <input type="text" class="form-control" id="birth_place" value="{{ $data->birth_place }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="start_work_date"
                                                name="start_work_date" value="{{ $data->start_work_date }}" placeholder="Pilih Tanggal Mulai Bekerja">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div id="contract" class="form-group col-md-6">
                                            <label class="form-label" for="contact_date">Tanggal Kontrak:
                                                (Opsional)</label>
                                            <input type="text" class="form-control" id="contact_date" value="{{ $data->contact_date }}"
