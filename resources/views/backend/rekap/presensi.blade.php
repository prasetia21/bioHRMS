                                    ...
                                    <form method="get" action="rekap-presensi">
                                        <div class="input-group">
                                            <select class="custom-select" name="month_filter" id="inputGroupSelect04"
                                                ...
                                                <option value="03" {{ $month == '03' ? 'selected' : '' }}>Maret
                                                </option>
                                                <option value="04" {{ $month == '04' ? 'selected' : '' }}>April
                                                </option>
                                                <option value="05" {{ $month == '05' ? 'selected' : '' }}>Mei
                                                </option>
                                                <option value="06" {{ $month == '06' ? 'selected' : '' }}>Juni
                                                </option>
                                                <option value="07" {{ $month == '07' ? 'selected' : '' }}>Juli
                                                </option>
