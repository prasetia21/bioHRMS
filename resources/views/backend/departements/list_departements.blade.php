...
@section('banner-desc')
    Halaman untuk Menambah Data Departemen yang Berjalan di Bioindustries
@endsection
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="card-action">
                                <a href="{{ route('tambah.departemen') }}" class="btn btn-primary" role="button">Tambah
                                    Baru</a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            <a href="/manage/departement/update/{{ $item->id }}"
                                                            ...
                                                            <form onsubmit="return confirmHapus(event)"
                                                                action="/manage/departement/remove/{{ $item->id }}"
